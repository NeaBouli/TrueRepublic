...
**Version:** v0.2.4 (Documentation Sync) -- tagged 25.02.2026
...
|------|--------|------|------|
| **Main** | `main` | `cd7face` (docs: update GitHub Pages release badge to v0.2.3) | `/Users/gio/TrueRepublic/` |
...
| v0.2.4 | Documentation Sync (Latest) | 25.02.2026 |
