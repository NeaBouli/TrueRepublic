...
<p align="center">
  <img src="https://img.shields.io/badge/tests-986%20recovery--verified-orange" alt="Recovery-verified tests"/>
...
./scripts/go-packages.sh go test -race -cover -count=1 -timeout=600s    # 952 Go cases
...
- 🟡 986 tests recovery-verified locally (952 Go + 26 Rust + 8 maintained-client), plus separately gated GH-56 rotation, GH-59 slashing, GH-60 inactive-validator genesis, and GH-61 legacy-authority migration process harnesses
...
> Historical test count: 577. The authoritative recovery-verified total is 986
> (952 Go + 26 Rust + 8 maintained-client), reproduced locally on the current branch.
