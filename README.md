...
<p align="center">
  <img src="https://img.shields.io/badge/tests-2314%20recovery--verified-orange" alt="Recovery-verified tests"/>
...
CGO_ENABLED=1 ./scripts/go-packages.sh go test -race -cover -count=1 -timeout=600s    # 1,969 Go cases
...
> Historical test count: 577. The authoritative recovery-verified total is 2,314
> (1,969 Go + 26 Rust + 319 maintained-client), reproduced from fresh
