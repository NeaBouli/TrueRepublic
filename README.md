...
<p align="center">
  <img src="https://img.shields.io/badge/tests-689%20recovery--verified-orange" alt="Recovery-verified tests"/>
...
**Known Limitations:** IBC staking/upgrade remains stubbed (PoD is used instead), a real ZKP prover/ceremony review is pending, and the bounded four-validator recovery harness does not yet cover backup/restore, upgrades, rollback, or independent operations review. See [LIMITATIONS.md](docs/LIMITATIONS.md).
...
- 🟡 689 tests recovery-verified locally (655 Go + 26 Rust + 8 maintained-client), plus the separately gated four-validator and six-node validator lifecycle process harnesses
...
> Historical test count: 577. The authoritative recovery-verified total is 689
> (655 Go + 26 Rust + 8 maintained-client), reproduced locally on the current branch.
