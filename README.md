...
<p align="center">
  <img src="https://img.shields.io/badge/tests-1220%20recovery--verified-orange" alt="Recovery-verified tests"/>
...
./scripts/go-packages.sh go test -race -cover -count=1 -timeout=600s    # 1,186 Go cases
...
- 🟡 1,220 tests recovery-verified locally and in CI (1,186 Go + 26 Rust + 8 maintained-client), plus separately gated GH-56 rotation, GH-59 slashing, GH-60 inactive-validator genesis, GH-61 legacy-authority migration, and GH-93 incident-rehearsal process harnesses
...
> Historical test count: 577. The authoritative recovery-verified total is 1,220
> (1,186 Go + 26 Rust + 8 maintained-client), reproduced from package-scoped
> JSON output on merged GH-93 evidence using the established passing-case method.
