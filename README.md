...
<p align="center">
  <img src="https://img.shields.io/badge/tests-1443%20recovery--verified-orange" alt="Recovery-verified tests"/>
...
- 🟡 1,443 tests recovery-verified locally and in CI (1,329 Go + 26 Rust + 88 maintained-client), plus the separately gated GH-115 local client-chain delivery proof and GH-56 rotation, GH-59 slashing, GH-60 inactive-validator genesis, GH-61 legacy-authority migration, GH-93 incident rehearsal, and GH-97 sustained-load process harnesses
...
> Historical test count: 577. The authoritative recovery-verified total is 1,443
> (1,329 Go + 26 Rust + 88 maintained-client), reproduced from package-scoped
