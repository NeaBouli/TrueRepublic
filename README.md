...
<p align="center">
  <img src="https://img.shields.io/badge/tests-2187%20recovery--verified-orange" alt="Recovery-verified tests"/>
...
CGO_ENABLED=1 ./scripts/go-packages.sh go test -race -cover -count=1 -timeout=600s    # 1,842 Go cases
...
- 🟡 GH-212 verifies exact release tool/platform/container-base pins, repeated
  ...
  metadata records under one exact commit and simulated-tag manifest. Cross-time
  hermetic rebuilds, a real tag, signing, publication and staged rollout remain
  open.
...
> Historical test count: 577. The authoritative recovery-verified total is 2,187
> (1,842 Go + 26 Rust + 319 maintained-client), reproduced from fresh
