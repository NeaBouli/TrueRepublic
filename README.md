...
<p align="center">
  <img src="https://img.shields.io/badge/tests-1573%20recovery--verified-orange" alt="Recovery-verified tests"/>
...
./scripts/go-packages.sh go test -race -cover -count=1 -timeout=600s    # 1,406 Go cases
...
> Historical test count: 577. The authoritative recovery-verified total is 1,573
> (1,406 Go + 26 Rust + 141 maintained-client), reproduced from package-scoped
