...
CGO_ENABLED=1 ./scripts/go-packages.sh go test -race -cover -count=1 -timeout=600s    # 1,576 Go cases
...
> Historical test count: 577. The authoritative recovery-verified total is 1,921
> (1,576 Go + 26 Rust + 319 maintained-client), reproduced from fresh
