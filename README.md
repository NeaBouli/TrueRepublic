...
<p align="center">
  <img src="https://img.shields.io/badge/tests-690%20recovery--verified-orange" alt="Recovery-verified tests"/>
...
./scripts/go-packages.sh go test -race -cover -count=1 -timeout=600s    # 656 tests
...
- 🟡 690 tests recovery-verified locally (656 Go + 26 Rust + 8 maintained-client), plus the separately gated multi-validator process harnesses
...
> Historical test count: 577. The authoritative recovery-verified total is 690
> (656 Go + 26 Rust + 8 maintained-client), reproduced locally on the current branch.
