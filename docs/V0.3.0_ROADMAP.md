...
**Historical state:** a web wallet and an untested React Native prototype once
existed with basic governance UI. The mobile prototype was retired under GH-102;
future mobile work requires a separately reviewed implementation.
...
- future mobile client (new, separately scoped implementation)
...
- Add maintained lint/format tooling for supported clients
