...
- [ ] Complete Sol line-by-line/security review, full local
  repository/client/security/docs gates, protected PR, merge, final-main,
  Pages, tracker, and both-Bridge synchronization before Done.
