...
- [x] Publish protected PR #295 at initial head `a9c5f25`; advance it after
  review hardening to final exact head `fc53a6f`.
- [x] Require its complete exact-head matrix, resolve review threads, merge,
