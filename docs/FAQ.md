...
### Where are the tests?
The recovery baseline has 1,609 verified standard-suite cases: 1,442 Go, 26
Rust, and 141 maintained-client tests. This total excludes the separate opt-in
GH-175/GH-178 IBC gate (`make ibc-two-chain`). Run
