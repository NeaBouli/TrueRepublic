...
namespace PixabaySharp.Models.Videos
{
    /// <summary>
    ...
    public class Videos
    {
        ...
        /// </summary>
        [JsonProperty("medium")]
        public Video Medium { get; set; } = null!;
        ...
        /// </summary>
        [JsonProperty("large")]
        public Video Large { get; set; } = null!;
