...
| Tests | 2,486 standard-suite total: 2,132 Go (including GH-304 ElectAdmin integrity/quarantine regressions, GH-294 security-review readiness, GH-278 locked CI-tool bootstrap evidence, GH-273 cross-run evidence, GH-261 candidate evidence, GH-258 repeated-OCI evidence, GH-244 rollout-genesis qualification, GH-225 release compatibility, GH-222 install-lifecycle, GH-209 recipient-binding and GH-206 pinned test-only prover coverage), 26 Rust, 328 maintained-client; separate GH-266 keeper replay, GH-206 native-verifier, GH-175/GH-178/GH-181 IBC, and GH-184 governed-upgrade gates excluded |
...
- [Independent Review Guide](https://github.com/NeaBouli/TrueRepublic/blob/main/docs/security/INDEPENDENT_REVIEW_GUIDE.md)
