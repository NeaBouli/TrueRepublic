...
The current **v0.4.0 recovery** source of truth records **1,482 verified cases**.

| Suite | Passing cases |
|---|---:|
| Go root/application | 114 |
...
The maintained client is verified with `npm ci`, lint, 104 cases (94 Vitest plus
