...
The current **v0.4.0 recovery** source of truth records **690 verified cases**.

| Suite | Passing cases |
|---|---:|
| Go root/application | 45 |
| Go token | 12 |
| Go treasury | 36 |
| Go DEX | 116 |
| Go governance | 447 |
...
GH-32/GH-41/GH-43/GH-45/GH-53/GH-55 add the separately gated four-validator
...
single-signer identity failover, and common-height app-hash tests. They do not
replace the remaining consensus-breaking migration, consensus-key rotation,
network policy, load, or independent operations gates.
