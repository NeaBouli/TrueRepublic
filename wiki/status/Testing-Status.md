...
The current **v0.4.0 recovery** source of truth records **2,353 verified
...
evidence and are not counted in the 2,008 Go subtotal.
...
dedicated gate, they add evidence without changing the 2,008 Go subtotal.
