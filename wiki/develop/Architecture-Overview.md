...
| **Test** | `CGO_ENABLED=1 ./scripts/go-packages.sh go test -race -cover -count=1 -timeout=600s` (1,596 standard-suite Go cases, including GH-225 release compatibility, GH-222 install-lifecycle, GH-209 recipient-binding and GH-206 test-only prover coverage; separate GH-206/GH-209 Go/WASM, GH-175/GH-178/GH-181 IBC, and GH-184 upgrade gates excluded) |
