...
| **Test** | `CGO_ENABLED=1 ./scripts/go-packages.sh go test -race -cover -count=1 -timeout=600s` (2,132 standard-suite Go cases, including GH-304 ElectAdmin integrity/quarantine regressions, GH-294 security-review readiness, GH-278 locked CI-tool bootstrap evidence, GH-261 candidate evidence, GH-258 repeated-OCI evidence, GH-244 rollout-genesis qualification, GH-225 release compatibility, GH-222 install-lifecycle, GH-209 recipient binding and GH-206 test-only prover coverage; separate GH-266 keeper replay, GH-206 native-verifier, GH-175/GH-178/GH-181 IBC, and GH-184 upgrade gates excluded) |
