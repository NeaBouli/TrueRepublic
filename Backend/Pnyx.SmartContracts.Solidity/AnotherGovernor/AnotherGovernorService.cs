...
using Pnyx.SmartContracts.Solidity.Contracts.AnotherGovernor.ContractDefinition;

namespace Pnyx.SmartContracts.Solidity.Contracts.AnotherGovernor
{
    public partial class AnotherGovernorService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, AnotherGovernorDeployment anotherGovernorDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<AnotherGovernorDeployment>().SendRequestAndWaitForReceiptAsync(anotherGovernorDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, AnotherGovernorDeployment anotherGovernorDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<AnotherGovernorDeployment>().SendRequestAsync(anotherGovernorDeployment);
        }

        public static async Task<AnotherGovernorService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, AnotherGovernorDeployment anotherGovernorDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, anotherGovernorDeployment, cancellationTokenSource);
            return new AnotherGovernorService(web3, receipt.ContractAddress);
        }
        ...
        public AnotherGovernorService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
