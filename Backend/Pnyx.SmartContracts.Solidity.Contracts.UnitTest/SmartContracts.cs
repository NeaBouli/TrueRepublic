...
using Pnyx.SmartContracts.Solidity.Contracts.Accounts;
...
namespace Pnyx.SmartContracts.Solidity.Contracts.UnitTest
{
    ...
    public class SmartContracts
    {
		...
		private static AccountCollection<ETHPnyxAccount> _accounts;
		...
		protected static void InitializeAccounts()
		{
			_accounts = new AccountCollection<ETHPnyxAccount>();
